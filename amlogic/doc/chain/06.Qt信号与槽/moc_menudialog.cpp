...
QT_MOC_LITERAL(3, 23, 4)
    ...
    "MenuDialog\0onOperator\0\0type"
};
...
void MenuDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onOperator((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MenuDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuDialog::onOperator)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MenuDialog::onOperator(QString _t1)
{
